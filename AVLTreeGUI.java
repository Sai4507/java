...
public class AVLTreeGUI extends Application {
    ...
    private Solution avlTree = new Solution(); // Use your existing AVL Tree logic
    private BSTNode root = null; // Root of the AVL Tree
    ...
    public void start(Stage primaryStage) {
        ...
        searchButton.setOnAction(e -> {
            try {
                int value = Integer.parseInt(inputField.getText().trim());
                BSTNode found = avlTree.searchNode(root, value);
                if (found != null) {
    ...
    private void drawTree(BSTNode node, double x, double y, double xOffset) {
        if (node == null) return;
